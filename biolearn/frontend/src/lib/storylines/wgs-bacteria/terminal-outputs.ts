...
export const helpTexts: Record<string, Record<string, string>> = {
	...
	'fastqc': {
		'main': [
			...
			'  -f, --format',
			'    Force file format (fastq, bam, sam)',
			'  --noextract',
	...
	'trimmomatic': {
		'main': [
			...
			'  MINLEN:<length>',
			'    Drop reads below specified length',
			'',
	...
	'unicycler': {
		'main': [
			...
			'    Reverse reads (FASTQ)',
			'  -l, --long',
			'    Long reads for hybrid assembly (optional)',
			'  -o, --out',
			'    Output directory',
			'  -t, --threads',
			'    Number of threads (default: 8)',
			'  --mode',
			'    Assembly mode: conservative, normal, bold (default: normal)',
			'  -h, --help',
	...
	'prokka': {
		'main': [
			...
			'  --genus',
			'    Genus name (triggers genus-specific BLAST)',
			'  --species',
			'    Species name',
			'  --strain',
			'    Strain name',
	...
	'abricate': {
		'main': [
			...
			'\x1b[1mOptions:\x1b[0m',
			'  --db',
			'    Database to use: ncbi, card, resfinder, vfdb, plasmidfinder',
			'  --minid',
			'    Minimum identity (default: 80)',
			'  --mincov',
			'    Minimum coverage (default: 80)',
			'  -h, --help',
			'    Show this help message',
			'',
	...
	'mlst': {
		'main': [
			...
			'\x1b[1mOptions:\x1b[0m',
			'  --scheme',
			'    Force use of a specific scheme',
			'  --list',
			'    List available schemes',
			'  --minid',
			'    Minimum identity (default: 95)',
			'  --mincov',
